    ...
    startScene([
        {
            ...
            value:
                ...
                "유리는 당신을 보더니 미소를 지었다. 그는 당신이 없었다면 자신은 이들을 구출하지 못했을 거라고 말했다. <br>" +
                "\"쉘터로 돌아갈까, {playerName}.\"<br>" +
    ...
    startScene([
        {
            type : "text",
            value :
                "당신은 조심스럽게 화려한 문을 열었다. 뒤에서 열리는 문소리에 루크가 당신을 돌아보았다. \"너....\", 루크의 말이 끝나기도 전에 앞에 있던 놈이 루크의 얼굴 쪽으로 칼을 휘둘렀다. 루크는 본능적으로 뒤로 물러났지만 그의 눈 아래로 피가 흘러내렸다." +
                "<br><br>\"그웰!\"<br><br>" +
