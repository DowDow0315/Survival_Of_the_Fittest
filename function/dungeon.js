        ...
        whiteFlowerLab_experimentB : [
            {
                ...
                value : [
                    ...
                    "<br><br>다시 가설을 수정한다. 가장 강한 감정은 <span class='log-pale'>창백</span>에게서 오는 것 같고, 나머지 감정들은 약하게 공유되는 것으로 보인다. 다른 것은 둘째치고, 무슨 일이 있어도 그것을 죽여야 한다. **에게 한번 더 요청해야 한다. 예전 실험에서도 그렇고 왜 계속 그것의 감정이 공유가 되는가." +
