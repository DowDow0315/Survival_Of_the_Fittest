    ...
    sewer: {
        ...
        rooms: {
            ...
            r0c7: {
                ...
                lockedText: "위화감은 느꼈지만, 아직 아무것도 알 수 없다."
            },
            r1c7: {
                name : "하얀꽃의 무덤",
                exits : {up:"r0c7"},
...
function handleDungeonBossWin(player, dungeon, room){
    ...
    if (dungeon.id === "whiteArmyState" && room.bossId === "whiteArmies_01"){
        handleWhiteArmies01Win(player);
        return;
    }
...
function leaveDungeon(player){
    ...
    if (dungeonId === "goblinCave"){
        ...
        player.location = "wastedRuin";
    } else if (dungeonId === "whiteArmyState"){
        player.location = "richTownEntrance";
                        ...
                        scene : [
                            {
                                ...
                                value : "성의를 보이라는 당신의 말에 그의 얼굴이 굳었다. 그는 주머니를 더듬거리더니 덜덜 떨리는 손으로 100원을 당신에게 건넸다." +
                                        " 도적질을 하는데 100원밖에 없다고? 당신이 그를 쳐다보자 그는 벌벌 떨며 자신에게 남은 것은 이제 아무것도 없다고 말했다. 그는 당신을 도적떼마냥 두려워하고 있다... 그는 100원을 당신에게 넘긴 후 그대로 도망쳐버렸다."
                            },
                            {
                                type : "effect",
                                run : (player) => {
        ...
        whiteFlowerLab_prison : [
            {
                type : "text",
                value : [
                    "감옥이다. 당신은 고개를 숙이고 감옥에 들어가야만 했다. 건장한 성인 남성이라면 제대로 서지도 못할 높이다. 여기에 갇혀있었던 사람들은 그럼 전부 앉아있었을까? 아니면 누워있었을까? 주변을 둘러보았지만 당신은 아무것도 찾을 수 없었다." +
                ...
                fail : [
                    {
                        type : "text",
                        value : [
                            "당신은 다시 한번 눈을 깜박여보았지만 아무것도 찾을 수 없었다. 갈 길을 가자...."
                        ]
                    }
                ]
            }
    ...
    startScene([
        {
            ...
            value : "당신은 상급도적의 공격을 버티지 못하고 쓰러졌다. 이제 끝이라고 생각했을 때, 억 하는 소리와 함께 당신에게 달려들던 도적이 옆으로 쓰러졌다. 피다. 그의 입에서 역류한 피가 당신을 붉은색으로 물들인다. 그리고 그순간 큭, 하는 소리가 났다. 당신은 간신히 눈을 떠서 루크를 바라보았다." +
                    " 루크의 뒤에 있던 그웰이 루크를 찌른 모양이다. 다행히 피해서 옆구리만 맞긴 했지만... 당신의 눈이 커졌다. 하지만 루크는 오히려 으르렁거리며 그딴 표정 짓고 있지 말라고 했다. 그리고 그는 쓰러져있는 당신을 내버려두고 다시 그웰에게 달려들었다. 그들이 싸우는 동안 당신은 아무것도 할 수 없었다." +
...
function runDungeonBossIntro(player, introId){
                ...
                choices: [
                    ...
                    },
                    {
                        ...
                        scene : [
                            {
                                type : "text",
                                value : "당신의 말에 도적대장은 멈췄다가 크하하 웃음을 터뜨렸다. <br><br>\"그렇군. 알량한 도덕심이 아니라 내 목에 걸린 돈 때문에 온 거였군!\"<br><br>그는 적으로 만나지 않았더라면 당신을 제 부하로 삼고 싶어했을 거라고 말했다. 칭찬같지 않은 칭찬이 끝나기도 전에 그가 던진 투척단검이 당신의 목을 향해 날아온다...!"
                            },
                            {
                                type : "effect",
                                run : (player) => {
    ...
    if (introId === "whiteArmies_01_intro"){
            startScene([
            {
                type: "text",
                value:
                      "가장 심부로 들어왔지만 책상 위에는 아무것도 없었다. 당신은 재빠르게 책상을 뒤졌지만 정말 어떤 서류도 찾을 수가 없었다. 이미 빼돌린 걸까? 당신이 책상 아래에서 고개를 든 순간, 당신은 책상 밑에 붙어있는 병 하나를 발견했다. 그 병에는 백색 흉물이 들어 있었다. 아니...." +
                      "<br><br>갓난아기 얼굴을 똑닮은 백색 흉물이 병 안에 둥둥 떠있었다. 백색 흉물은 당신을 멍하니 바라보다가 모습을 바꾸기 시작했다. 당신은 백색 흉물이 모습을 바꾸는 것을 바라보았다." +
                      "<br><br>하지만 그 순간, 책상이 두동강나면서 당신은 재빨리 뒤로 피했다. 백색 군단이다. 백색 기사단장이 당신을 내려다보았다." +
                      "<br><br>\"...손을 더럽히지 않고서도 이 세상을 지킬 수 있다고 보나? 오로지 너만의 힘으로 상류도시, 아니, 너에게는 하류도시겠지, 하류도시를 지킬 수 있다고 보는 건가?\"<br><br>" +
                      "그의 장창이 당신의 목을 겨누었다." +
                      "<br><br>\"진정으로 그렇게 믿고 있다면, 이 세상에서 가장 위험한 사람은 너다, 하류도시의 영웅.\""
            },
            {
                type : "effect",
                run : (player) => {
                    startWhiteArmies01Battle(player);
                    return true;
                }
            }
        ], player);
    ...
    if (introId === "rebelsArmies_01_intro"){
            startScene([
            {
                type: "text",
                value:
                      "가장 안쪽 방에 가까워지자, 문 너머에서 반란군들이 대화하는 소리가 들렸다. 무언가를 챙기는 듯 부스럭거리는 소리도 끊이지 않았다.<br><br>" +
                      "\"그 폭탄이 불발되지만 않았다면 천국으로 가는 길을 끊고 발렌의 성을 고립시킬 수 있었을 텐데.\"<br><br>" +
                      "<br><br>\"다른 반란군 세력들은 너무 유약하다. 우리에게 이미 가족은 없어. 다시 만난다고 해도 어차피.... 살아있는 꼴은 아닐 테다. 그러니까 다른 가족들이 무너지기 전에 우리가 먼저 그들을 처부숴야 한다. 흔적도 남지 않도록.\"<br><br>" +
                      "그리고 문이 열렸다. 반란군들은 당신을 발견하자마자 전투 태세를 갖추었다. 반란군 작전 대장은 당신을 노려보더니 총구로 당신의 미간을 겨누었다." +
                      "<br><br>\"하류도시를 위해서는 죽어줘야겠다, 하류도시의 역적.\""
            },
            {
                type : "effect",
                run : (player) => {
                    startRebelsArmies01Battle(player);
                    return true;
                }
            }
        ], player);
    ...
    startScene([
        {
            type: "text",
            value:
                "당신은 에르윈을 이겼다. 쓰러진 에르윈은 마지막까지 저 멀리로 손을 뻗었지만 결국에는 아무것도 잡지 못하고 그대로 몸이 팔부터 부서져내렸다. 그가 부서져내린 자리에는 수북한 하얀꽃들만이 남았다." +
    ...
    startScene([
        ...
        },
        {
            ...
            value : "3번의 총성 후, 에릭은 천천히 당신을 놓아주었다. 하지만 당신이 그대로 쓰러지려고 하자, 그는 주저하지 않고 당신을 그대로 한손에 낀 후 마물의 은신처를 나왔다." +
                    ...
                    "그는 누가 마물을 퇴치했는지 주어를 말하지 않았지만, 경계병들은 당신이 마물을 처치한 걸로 받아들인 모양이다. 그들은 마물을 퇴치하고서도 살아돌아온 것이 영웅 그 자체라고 믿으며 당신이 기력과 체력을 회복할 때까지 당신을 지켜주었다." +
    ...
    startScene([
        {
            type:"text",
            value:
                "당신은 또 한번 패배했지만 유리의 손은 절대로 당신의 손을 놓지 않았다. 그는 아이들은 전부 지키지 못했지만 당신만큼은 놓칠 수 없었다. <br><br>시야가 껌껌해지고 다시 눈을 떴을 때 유리는 당신의 옆에 있었다, 언제나처럼."
        }
    ], player);
}
    ...
    startScene([
        {
            type: "text",
            value:
                "당신은 무기를 거두었다. 반란군 수장은 믿을 수 없다는 듯이 당신을 바라보다가 \"역시...\"라는 말과 함께 자리에서 일어났다. 그는 그 반지의 주인에게 우리는 아직 살아있다고 전해달라고 부탁했다. 그리고 우리는, 여전히 당신의 도움을 필요로 한다는 말까지." +
