        ...
        scene : [
            {
                ...
                value : [
                    ...
                    "<br>흉물은 당신의 몸을 마치 자신의 것처럼 다루었다. 앞, 뒤, 가슴.... 당신은 흉물의 피스톤질에 맞춰 앞뒤로, 그리고 위아래로도 격렬하게 흔들렸다. 흐려지는 시야 사이로 당신은 살점들을 보았다. 이미 상체는 어디 갔는지 모르겠는데 하반신의 구멍만 뚝뚝 알을 흘리고 있는 살점들도 있었고, 반대로 상체만 나와서 큰 가슴에서 뚝뚝 흉물의 알을 배출하는 살점들도 있었다. 당신은 그들이 차라리 죽은 것이라 믿고 싶었다." +
        ...
        scene : [
            {
                type : "text",
                value : [
                    "당신이 눈을 떴을 때 역겨운 냄새와 달콤한 냄새가 섞여서 끔찍한 혼종을 만들어내고 있었다. 꽃인간은 계속 걷고 있었고, 당신은 그 꽃인간에서 만들어진 흉물에 붙잡혀 모든 구멍을 침범당하고 있었다." +
                    "<br>다시 시야가 멀어진다. 하지만 당신은 어떻게든 정신을 차렸다. 얼마나 당했는지 당신은 구멍에 이물질이 들었는데도 위화감이 느껴지지 않을 정도였다. 당신의 신음 소리가 작아지자 꽃인간은 당신을 올려다보았다." +
                    " 그러더니 장난감을 버리는 것처럼 툭, 그대로 당신을 바닥으로 던져버렸다." +
                    "<br><br>당신은 누워서 기회를 노렸다. 그리고 그가 멀어졌을 때 당신은 그가 돌아오기 전에 재빨리 몸을 피했다. 어떻게든 도착한 구석에서 당신은 그대로 정신을 잃었다."
                ]
            },
            {
                type : "effect",
...
const DEFEAT_EVENTS = {
            ...
            scene : [
                {
                    ...
                    value : {
                        male : [
                            "\"안녕, 하세요.\"<br><br>" +
                            "꽃인간은 당신을 보며 계속 인사를 했다. 그는 당신을 꽈악 끌어안은 채 자신의 성기를 당신의 성기에 비볐다. 당신의 성별에 맞춰 그의 성기는 여성기로 변했다. 그는 당신의 남성기를 자신의 여성기로 받아들였다." +
                            "<br><br>\"반가워요.\"<br><br>\"오늘도 수고하셨습니다.\"<br><br>\"감사해요.\"<br><br>당신은 인사를 들으며 역강간당하고 있다. 그는 당신의 엉덩이를 두 팔로 밀며 계속 당신의 남성기를 자극했다. 당신의 남성기가 딱딱해지자 꽃인간은 만족했다." +
                            "<br><br>\"보고 싶어요.\"<br><br>\"사랑해요.\"<br><br>연인이 할 법을 말하며 그는 당신을 기대하는 눈으로 바라보았다. 그는 당신도 연인다운 말을 해주길 바라는 거 같다. 상황이 괴기하다는 걸 모르는 건 꽃인간뿐이었다. 그는 계속해서 고개를 갸웃거리며 당신과 성행위를 이어갔다." +
                            "<br>당신이 사정을 하고 나서야 그는 당신을 풀어주었다. 그는 정말로 연인처럼 당신의 입술 위로 가볍게 입술을 맞추었다. <br><br>\"다음에 또 봐요.\"<br><br>\"건강해요.\"" +
                            "<br><br>그가 멀어지고 당신의 시야는 암전됐다."
                        ],
                        female : [
                            "\"안녕, 하세요.\"<br><br>" +
                            "꽃인간은 당신을 보며 계속 인사를 했다. 그는 당신을 꽈악 끌어안은 채 자신의 성기를 당신의 성기에 비볐다. 당신의 성별에 맞춰 그의 성기는 남성기로 변했다. 그는 자신의 남성기를 당신의 여성기에 집어넣었다. 꽉 들어찬 느낌에 당신의 몸이 본능적으로 바르작거렸다." +
                            "<br><br>\"반가워요.\"<br><br>\"오늘도 수고하셨습니다.\"<br><br>\"감사해요.\"<br><br>당신은 인사를 들으며 강간당하고 있다. 틈 하나 없이 빼곡하게 감싸안고 그는 당신의 지스팟을 계속 찔러댔다. 당신이 조금이라도 느끼는 거 같으면 꽃인간의 표정이 밝아졌다." +
                            "<br><br>\"보고 싶어요.\"<br><br>\"사랑해요.\"<br><br>연인이 할 법을 말하며 그는 당신을 기대하는 눈으로 바라보았다. 그는 당신도 연인다운 말을 해주길 바라는 거 같다. 상황이 괴기하다는 걸 모르는 건 꽃인간뿐이었다. 그는 계속해서 고개를 갸웃거리며 당신과 성행위를 이어갔다." +
                            "<br>당신의 안에 꿀물이 가득 차고 나서야 그는 당신을 풀어주었다. 그는 정말로 연인처럼 당신의 입술 위로 가볍게 입술을 맞추었다. <br><br>\"다음에 또 봐요.\"<br><br>\"건강해요.\"" +
                            "<br><br>그가 멀어지고 당신의 시야는 암전됐다."
                        ]
                    }
                },
            ...
            scene : [
                {
                    ...
                    value : {
                        male : [
                            "백발꽃인간은 당신을 풀어주더니 당신의 뺨을 쓰다듬었다. 그는 당신을 연인처럼 대하기 시작했다. 그는 당신의 두 손을 채찍으로 묶더니 그대로 자신의 목 뒤로 둘렀다. ...마치 당신이 그 꽃인간을 껴안은 것처럼 보인다." +
                            "<br>당신이 제 촉수를 무서워한다는 걸 알아차렸는지 꽃인간은 자신의 촉수를 거둬들였고, 몸통도 보통 인간의 길이로 돌아왔다. 당신을 바라보고 있는 그의 금안은 정말 꿀이라도 떨어질 것처럼 달콤했다. 그는 당신에게 천천히 키스했고 마치 침대에 쓰러지듯 당신의 위로 엎어졌다." +
                            "<br>섹스는 거칠지 않았다. 그저 사랑하는 연인이 하는 것처럼 부드럽기만 했다. 당신이 꽃인간이 아니라 인간이랑 하고 있다고 중간에 착각할 정도였다. 당신의 반응을 보던 꽃인간은 웃었다. 그리고 당신의 몸을 애무했다, 꽤나 긴 시간 동안." +
                            " 당신이 미칠 거 같아서 허리를 떨 때까지 계속, 그는 당신의 몸을 애무했다. 그는 당신의 귀옆에 대고 속삭였다. <br><br>\"무서워하지 마.\"<br><br>그는 당신에게 당신을 해칠 의도가 없다고 말하고 있었다." +
                            "<br>그는 당신의 다리를 벌렸다. 벌어진 두 다리 사이에 자리를 잡은 그는 미소를 짓더니 그대로 천천히 자신의 남성기를 당신의 애널에 밀어넣었다. 아프지 않았다. 달콤한 향기 때문인지, 아니면 그가 부드럽게 해주기 때문인지, 당신은 고통따위는 느끼지 못했다. 당신을 장악하는 건 오로지 쾌락뿐이었다." +
                            "<br>정신을 차렸을 때 당신은 그를 꽈악 끌어안은 채 스스로 허리를 흔들며 그에게 달라붙고 있었다. 그는 웃었다. 웃음 소리가 멀어졌다가 가까워진다." +
                            "<br><br>다시 눈을 깜박였을 때 그는 이미 없었다. 당신은 몸을 일으키려다가 그대로 쓰러졌다. 그냥 자고 싶었다. 당신은 달콤한 냄새에 취해 다시 잠에 들었다."
                        ],
                        female : [
                            "백발꽃인간은 당신을 풀어주더니 당신의 뺨을 쓰다듬었다. 그는 당신을 연인처럼 대하기 시작했다. 그는 당신의 두 손을 채찍으로 묶더니 그대로 자신의 목 뒤로 둘렀다. ...마치 당신이 그 꽃인간을 껴안은 것처럼 보인다." +
                            "<br>당신이 제 촉수를 무서워한다는 걸 알아차렸는지 꽃인간은 자신의 촉수를 거둬들였고, 몸통도 보통 인간의 길이로 돌아왔다. 당신을 바라보고 있는 그의 금안은 정말 꿀이라도 떨어질 것처럼 달콤했다. 그는 당신에게 천천히 키스했고 마치 침대에 쓰러지듯 당신의 위로 엎어졌다." +
                            "<br>섹스는 거칠지 않았다. 그저 사랑하는 연인이 하는 것처럼 부드럽기만 했다. 당신이 꽃인간이 아니라 인간이랑 하고 있다고 중간에 착각할 정도였다. 당신의 반응을 보던 꽃인간은 웃었다. 그리고 당신의 몸을 애무했다, 꽤나 긴 시간 동안." +
                            " 당신이 미칠 거 같아서 허리를 떨 때까지 계속, 그는 당신의 몸을 애무했다. 그는 당신의 귀옆에 대고 속삭였다. <br><br>\"무서워하지 마.\"<br><br>그는 당신에게 당신을 해칠 의도가 없다고 말하고 있었다." +
                            "<br>그는 당신의 다리를 벌렸다. 벌어진 두 다리 사이에 자리를 잡은 그는 미소를 짓더니 그대로 천천히 자신의 남성기를 당신의 보지에 밀어넣었다. 아프지 않았다. 달콤한 향기 때문인지, 아니면 그가 부드럽게 해주기 때문인지, 당신은 고통따위는 느끼지 못했다. 당신을 장악하는 건 오로지 쾌락뿐이었다." +
                            "<br>정신을 차렸을 때 당신은 그를 꽈악 끌어안은 채 스스로 허리를 흔들며 그에게 달라붙고 있었다. 그는 웃었다. 웃음 소리가 멀어졌다가 가까워진다." +
                            "<br><br>다시 눈을 깜박였을 때 그는 이미 없었다. 당신은 몸을 일으키려다가 그대로 쓰러졌다. 그냥 자고 싶었다. 당신은 달콤한 냄새에 취해 다시 잠에 들었다."
                        ]
                    }
                },
                {
                   ...
                   if (player.gender === "male"){
                   changeSensitivity(player, "bSensitivity", 35);
                   changeSensitivity(player, "aSensitivity", 35);
                   changeSensitivity(player, "mSensitivity", 35);
                   addBodyFluid(player, "m", 70);
                   addBodyFluid(player, "a", 70);
                   } else {
                   changeSensitivity(player, "bSensitivity", 35);
                   changeSensitivity(player, "cSensitivity", 35);
                   changeSensitivity(player, "mSensitivity", 35);
                   changeSensitivity(player, "aSensitivity", 35);
                   addBodyFluid(player, "c", 70);
                   addBodyFluid(player, "m", 70);
                   addBodyFluid(player, "a", 70);
                   }
                   }
    ...
    experimentTeacher : [
        {
            id : "experimentTeacher_gameOver",
            weight : 100,
            scene : [
                {
                    type : "text",
                    value : [
                        "당신은 더 이상 버틸 수 없었다. 지휘봉을 든 그가 당신에게 다가왔다. 그는 당신에게는 많은 교정이 필요하다고 말했다. 당신의 팔을 톡톡 치더니 주사바늘을 가져다댄다." +
                        "<br><br>당신은 다음 번에 눈을 떴을 때 당신은 당신이 아닐 거라는 것을 직감했다. 당신은 저항했지만 그의 팔을 뿌리칠 수는 없었다." +
                        "<br><br>하류도시의 영웅은, 그렇게 이 세상에서 사라졌다."
                    ]
                },
                {
                    type : "effect",
