    ...
    startScene([
        {
            ...
            value : [
                ...
                "<br><br>여기저기서 들리는 비명 소리, 당신은 경비병의 팔이 잘려나가는 것을 보았다. 그대로 경비병의 가슴을 단검이 파고들려고 할 때, 루크가 너클로 단검을 팅 튕겨냈다.",
                "<br><br>\"씨발새끼들이...\"<br><br>",
                "루크가 오면서 경비병들은 그나마 정신을 차린 듯했다. 그들의 어수선했던 대열이 다시 정비된다. 루크는 팔이 잘린 경비병은 뒤로 물러나게 했다. <br><br>\"씨발, 넌 꺼져. 남은 개새끼들은 후퇴하면 뒤질 준비하고.\"<br><br>도적떼가 들끓는 건 알고 있었다. 행상인 습격 건은 많이 들었으니까. 하지만 도적떼가 직접적으로 마을에 처들어온 적은 지금까지 없는데.... 그 순간 당신의 앞으로 도적이 달려들었다.",
                "<br><br><div style='color:red'>전투를 피할 수는 없을 거 같다...!</div>"
            ]
        },
        {
            type : "effect",
