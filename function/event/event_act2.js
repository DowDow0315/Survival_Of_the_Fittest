...
window.EVENTS.push({
    ...
    action : (player) => {
        ...
        changeNPCEmotion("pale", "affection", 10);
        player.location = "townEntrance_act3";
        passTime(player, 1680);
        savePlayer(player);
        ...
        startScene([
            ...
            },
            {
                ...
                value : [
                    ...
                    " 그러다가 그것은 당신에게 다가왔다. 당신이 자신에게 위험하지 않다는 것을 살피고 고개를 갸웃거리며, 그것은 당신에게 손을 뻗는다. 만약 당신이 그것의 손길을 거부했다면 당신은 그날 죽었을지도 모른다. 하지만 당신은 그것의 손길을 받아들였다." +
