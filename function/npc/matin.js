            ...
            startScene([
                {
                    type : "text",
                    value : pickRandom([
                        "마틴은 당신이 곁에 오자 몸을 움찔하긴 했지만 유리잔을 닦는 일은 멈추지 않았다. 당신이 그를 빤히 바라보자 그는 작게 한숨을 쉬더니 은근히 당신 쪽으로 몸을 기울였다. <br><br>\"일하는데 방해돼.\"<br><br>하지만 저리 가라는 소리는 하지 않는다.",
                        ...
                        "\"...나는 말재주가 없어. 너도 알잖아.\"<br><br>그는 당신을 힐끗 보더니 다시 시선을 내렸다. <br><br>\"...하지만 네 얘기라면 들어줄게.\""
                    ])
                }
            ], player, { onEnd });
            ...
            startScene([
                {
                    type : "text",
                    value : pickRandom([
                        "마틴은 당신을 힐끗 보더니 이내 신경쓰지 않는다는 듯 고개를 돌려 자신의 일에 전념했다. 당신의 시선이 계속 느껴졌는지 마틴은 슬쩍 고개를 당신의 반대 방향으로 틀어버렸다.",
                        "퀘스트 용지를 관리하고 있던 마틴과 당신의 시선이 마주쳤다. 마틴은 당신에게 고개만 까닥이더니 다시 자신의 일에 집중했다. <br>...손이 아주 조금 느려진 것 같기도?",
                        "당신의 시선이 느껴졌는지 마틴은 낮게 한숨을 쉬었다. <br><br>\"넌 진짜... 이상한 녀석이야.\""
                    ])
                }
            ], player, { onEnd });
        } else{
