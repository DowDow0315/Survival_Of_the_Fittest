            ...
            startScene([
                {
                    type : "text",
                    value : pickRandom([
                        "유리는 당신과 시선을 마주치더니 얼굴을 붉혔다. 그는 당신이 이 쉘터에 있어줘서 다행이라고 말하며 자신의 어깨를 톡톡 두드렸다. 당신이 그의 어꺠에 머리를 기대자, 그의 몸은 눈에 띄게 굳었다. 쑥스러운 모양이다.",
                        "\"너와 더 대화하고 싶어.\"<br><br>유리는 아쉬운 듯이 낮게 한숨을 쉬었다.<br><br>\"오늘도 말 걸어줘서 고마워, {yuriTitle}. 네 미소 보니까 좋다.\"",
                        "무기를 갈고 있던 유리는 당신에게 무기의 날을 어떻게 가는지에 대해 가르쳐주었다. 그는 무기의 날을 가는 당신을 지켜보다가 당신의 손을 잡고 세심하게 움직여주었다. 손을 똈을 때, 그의 귀끝은 조금 붉어져있었다.",
            ...
            startScene([
                {
                    type : "text",
                    value : pickRandom([
                        "유리는 당신과 얘기를 하다가 꾸벅꾸벅 좋았다. 당신이 그의 이마를 톡 치자, 유리는 화들짝 놀라서 깨어났다.<br><br>\"미안해. 네가 내준 시간인데...\"<br><br>유리가 당신을 꽈악 끌어안았다.",
                        "유리는 당신과 애기를 나누다가 아이가 깬 소리에 화들짝 놀라서 일어났다. 그는 당신을 바라보며 사과했다. <br><br>\"미안. 다음 번에 또.\"",
