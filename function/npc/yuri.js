    ...
    startScene([
        {
            ...
            value : [
                ...
                "유리는 쿡쿡 웃으며 자연스럽게 당신의 옆에 앉았다. 그는 당신의 손위로 손장난을 치며 그래도 걱정하지 말라고 말했다." +
                ...
                "<br><br>\"진심이야.\"<br><br>" +
                "나는 어렸을 떄부터 너랑 떨어진다는 생각을 한 적이 없거든. 유리는 당신에게 속삭이더니 웃으며 다시 당신과 거리를 벌렸다. 물론 그래도 두 사람의 그림자는 계속 붙어 있었지만. 한 해의 마지막 밤이 지날 때까지 쭈욱."
            ]
        }
    ], player, {
